      ...
      <div className="relative z-10 h-full flex items-end pb-32">
        <div className="max-w-2xl px-4 sm:px-6 lg:px-12">
          ...
          <div className="flex items-center space-x-2 mb-4">
            <span className="text-netflix-red text-xl font-bold">N</span>
            <span className="text-white/80 text-sm uppercase tracking-wider">Series</span>
          </div>
          ...
          <div className="flex items-center space-x-4 text-sm text-white mb-4">
            ...
            <span className="flex items-center">
              ...
              Starring {movie.vote_average > 7 ? 'Award Winners' : 'Popular Actors'}
            </span>
          </div>
