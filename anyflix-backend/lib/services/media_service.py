"""Unified media service for managing streaming providers with optional metadata enrichment."""
...
class MediaService:
    ...
    def __init__(
        ...
        """Initialize media service with available streaming providers.
        ...
        if self.enable_metadata and ENHANCED_FEATURES_AVAILABLE:
            ...
            self.logger.info(
                f"MediaService initialized with metadata enrichment enabled "
            ...
            self.logger.info(
                "MediaService initialized with metadata enrichment disabled"
            )

        self.logger.info(
            f"Initialized MediaService with providers: {list(self.providers.keys())}"
        )
